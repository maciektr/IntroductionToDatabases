class Participant:
    def __init__(self, id, faker, client_id=None):
        self.id = id
    ...
    def to_sql(self):
        if self.client_id is not None:
            res = "INSERT INTO Participants (participant_id,clients_id, name, surname, email, phone) VALUES (" + str(
                self.id) + "," + str(self.client_id) + ",\'" + self.name + "\',\'" + self.surname + "\',\'" + self.email + "\',\'" + self.phone + "\')"
        else:
            res = "INSERT INTO Participants (participant_id, name, surname, email, phone) VALUES (" + str(
                self.id) + ",\'" + self.name + "\',\'" + self.surname + "\',\'" + self.email + "\',\'" + self.phone + "\')"
        return res
